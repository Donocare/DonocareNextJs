...
const services = [
  {
    title: "Book Keeping Monthly",
    icon: <ClipboardListIcon className="h-10 w-10 text-indigo-600" />,
  },
  {
    title: "Preparation of Financial Statements",
    icon: <DocumentTextIcon className="h-10 w-10 text-purple-600" />,
  },
  {
    title: "Inventory Stock Management",
    icon: <CubeTransparentIcon className="h-10 w-10 text-pink-600" />,
  },
  {
    title: "Preparation Financial Statement",
    icon: <PresentationChartLineIcon className="h-10 w-10 text-blue-600" />,
  },
  {
    title: "AUDIT",
...
export default function AccountManagement() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-12 overflow-hidden">
      ...
      <div className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-indigo-300 rounded-full filter blur-3xl opacity-20 z-0 animate-pulse" />
      <div className="absolute bottom-[-150px] right-[-150px] w-[500px] h-[500px] bg-pink-300 rounded-full filter blur-2xl opacity-20 z-0 animate-pulse" />
      <div className="absolute top-[30%] left-[40%] w-[250px] h-[250px] bg-purple-200 rounded-full filter blur-2xl opacity-10 z-0" />
